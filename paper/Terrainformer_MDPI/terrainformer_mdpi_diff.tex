...
%DIF ADD new.tex   Thu May 28 14:28:56 2026
\firstpage{1}
\makeatletter
...
\begin{figure}[H]
    \centering
    {\setlength{\fboxrule}{1.2pt}\setlength{\fboxsep}{2pt}\fcolorbox{red}{white}{\includegraphics[width=\linewidth]{tech_tree.png}}}
...
\DIFadd{Three rows of Tables~\ref{tab:method_arch} and~\ref{tab:method_caps} are worth picking out. (i) BADGR \mbox{%DIFAUXCMD
\cite{kahn2021} }\hskip0pt%DIFAUXCMD
...
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL {\setlength{\fboxrule}{1.2pt}\setlength{\fboxsep}{2pt}\fcolorbox{red}{white}{\includegraphics[width=\linewidth]{world_model_diagram.png}}}
...
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL {\setlength{\fboxrule}{1.2pt}\setlength{\fboxsep}{2pt}\fcolorbox{red}{white}{\includegraphics[width=\linewidth]{dt_diagram.png}}}
...
\begin{figure}[H]
    \centering
    {\setlength{\fboxrule}{1.2pt}\setlength{\fboxsep}{2pt}\fcolorbox{red}{white}{\includegraphics[width=\linewidth]{dataset_examples.png}}}
...
\begin{figure}[H]
    \centering
    {\setlength{\fboxrule}{1.2pt}\setlength{\fboxsep}{2pt}\fcolorbox{red}{white}{\includegraphics[width=\linewidth]{loss_curves.png}}}
...
\DIFadd{We use $K{=}5$ action chunks aggregated at inference by TemporalEnsemble with exponential-decay weighting ($\lambda{=}0.9$). The choice of $K$ trades two effects:
}\begin{itemize}
...
\begin{figure}[H]
    \centering
    {\setlength{\fboxrule}{1.2pt}\setlength{\fboxsep}{2pt}\fcolorbox{red}{white}{\includegraphics[width=\linewidth]{simulator_screenshot.png}}}
