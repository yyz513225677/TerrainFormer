...
\begin{figure}[H]
    \centering
    {\setlength{\fboxrule}{3pt}\setlength{\fboxsep}{4pt}\fcolorbox{red}{white}{%
        \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}%
        \hfill\colorbox{red}{\textcolor{white}{\textbf{\footnotesize\,NEW\,}}}%
        \\[-1.2ex]
...
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL {\setlength{\fboxrule}{3pt}\setlength{\fboxsep}{4pt}\fcolorbox{red}{white}{%
        \begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}%
        \hfill\colorbox{red}{\textcolor{white}{\textbf{\footnotesize\,NEW\,}}}%
        \\[-1.2ex]
